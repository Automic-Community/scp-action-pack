...
public class GetFiles extends AbstractPublicFeature {
    ...
    public void initialize() {
        ...
        protocol = parser.addHelp(parser.addStringOption("prc", "protocol", true),
                "Protocol used to get file/directory from remote machine. SCP are supported.");
        ...
        port = parser.addHelp(parser.addStringOption("p", "port", false),
                "Port number of the source machine. Default: 22(scp). ");
    ...
    public int run(String[] args) throws Exception {
        ...
        try {
            ...
            Logger.log("Cannot get Port value,  use Default Value: 22(scp).", this.loglevelValue);
        }
