...
###### Description
 ...
 This Action Pack enables you to securely transfer files and directories over the network.
...
Please refer to the link for [package documentation](source/ae/DOCUMENTATION/PCK.AUTOMIC_SCP.PUB.DOC.xml)
